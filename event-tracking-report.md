...
- **event_card_clicked**: Fired when a user clicks on an event card to view its details.

### components\ExploreBtn.tsx

- **explore_events_button_clicked**: Fired when a user clicks the 'Explore Events' button.

### components\Navbar.tsx

- **navbar_logo_clicked**: Fired when the user clicks on the site logo in the navigation bar.
- **navbar_link_clicked**: Fired when the user clicks on a text link (e.g., Home, Events, Create) in the navigation bar.
